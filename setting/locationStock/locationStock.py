...
# @Time     : 2020/12/29 11:38
# @Author   : LiuXiaoQiang
# @Site     : https://github.com/qq183727918
# @File     : locationStock.py
# @Software : PyCharm
...
class SemLocationStock:
    ...
    def __init__(self):
        ...
        self.url = f'{self.urla}scp/inventory/locationStock'

    def locationStock(self):
        """
        定义driver
        """
